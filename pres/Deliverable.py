...
class Deliverable:
    ...
    def __init__(self, output_file, output_folder, input_file, input_folder):
...
class OneSecondDeck(Deliverable):
    ...
    def __init__(self, output_file, output_folder, input_file, input_folder):
        super(OneSecondDeck, self).__init__(output_file, output_folder, input_file, input_folder)
        ...
        try:
            ...
            if gesuchter_platzhalter:
                ...
                if placeBehind == True:
                    ...
                    shapes.insert(2, picture._element)  
